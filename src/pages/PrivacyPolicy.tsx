...
const import { Link } from 'react-router-dom';
import { Button } from '@/components/ui/button';
import { ArrowLeft, Moon, Sun } from 'lucide-react';
import { useTheme } from 'next-themes';

const TermsAndConditions = () => { // Note: For semantic clarity, in a real app, this component might be renamed 'PrivacyPolicy'
...
export default PrivacyPolicy; = () => { // Note: For semantic clarity, in a real app, this component might be renamed 'PrivacyPolicy'
  const { theme, setTheme } = useTheme();
