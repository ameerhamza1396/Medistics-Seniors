...
const features = [
  ...
  {
    icon: Users,
    title: "Full Lenght Paper",
    description: "Test your preperations with system choosen questions craved out from past exams.",
        ...
        <div className="container mx-auto px-4 lg:px-8 py-12 lg:py-20 max-w-7xl relative z-10">
          ...
          <div className="animate-fade-in" style={{ animationDelay: '0.4s', animationFillMode: 'both' }}>
            <p className="text-lg md:text-xl text-gray-200 mb-8 max-w-3xl">
              Medmacs.app is Pakistan's most advanced AI-powered MBBS preparation platform, designed to help you master medical concepts, practice MCQs, and achieve your dream score with personalized learning experiences.
            </p>
          </div>
        ...
        <div className="text-center w-full relative z-10">
          <div className="animate-fade-in mb-12">
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-12 max-w-2xl mx-auto">
              See the numbers behind Medmacs' growing community and proven results.
            </p>
          </div>
      ...
      <section id="value-prop" className="min-h-screen flex items-center justify-center container mx-auto px-4 lg:px-8 py-12 lg:py-20 max-w-7xl text-center">
        <div className="animate-fade-in">
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
            Say goodbye to generic study methods. Medmacs leverages advanced AI to provide a truly personalized and engaging learning experience, designed to help you not just pass, but excel.
          </p>
...
>
  ...
  <div className="relative z-10 container mx-auto max-w-7xl animate-fade-in">
    ...
    <div className="flex flex-col sm:flex-row justify-center gap-4">
      ...
      <Button
        size="lg"
              className="px-8 py-4 hover:scale-105 transition-all duration-300 hover:shadow-2xl group bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-white hover:text-white"
  ...
  <div className="container mx-auto max-w-5xl text-center">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 animate-fade-in">
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <a
          href="mailto:contact@medmacs.com"
          className="text-purple-600 dark:text-pink-400 hover:text-purple-800 dark:hover:text-pink-600 transition-colors duration-300"
          aria-label="Email"
        >
          contact@medmacs.app
        ...
        <div className="container mx-auto px-4 lg:px-8 text-center max-w-7xl relative z-10 flex-grow flex items-center justify-center">
          <div className="animate-fade-in">
            ...
            <p className="text-lg md:text-xl mb-8 opacity-90 max-w-2xl mx-auto">
              Join the most advanced Medical learning platform of the country.
            </p>
            <Link to="/signup">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              <div>
                ...
                <p className="text-gray-400">
                  Empowering Medicos across Pakistan with AI-powered learning.
                </p>
              </div>
